...
export const defaultFrameworks: FrameworkStatus[] = [
  ...
  },
  {
    ...
    integrationBatch: 8,
    ownerCommander: 'Tank',
    license: 'MIT source code only; third-party live data, datasets and 3D assets require separate terms/licence review',
    sourceUrl: 'https://github.com/bilawalsidhu/gods-eye-view',
    implementationStatus: 'license-review-required',
    state: 'not-installed',
    executionEnabled: false,
    capabilities: ['Static geospatial visualisation concepts', 'Source attribution and provenance UX review', 'Public-data privacy and safety boundary planning'],
    activationBoundary: 'sandboxed',
    detail: 'Geospatial safety intake only; no Cesium globe, live feeds, CCTV, location, voice, browser permission, API key, proxy or tracking runtime is started.',
  },
  {
    ...
    sourceUrl: 'https://github.com/Shashank7275/NEXA_AI_ASSISTANT',
    implementationStatus: 'source-review-required',
    state: 'not-installed',
    executionEnabled: false,
    capabilities: ['Filename-only workspace navigation concept', 'Local-memory and intent-routing comparison', 'Future consented desktop-assistant safety design'],
    activationBoundary: 'reference-only',
    detail: 'Source-review intake only; no upstream NEXA code, configuration, voice, screen, vision, browser, device, model or automation runtime is started.',
  },
  {
    ...
    integrationBatch: 10,
    ownerCommander: 'Nox',
    license: 'Unverified for Jarvis root/CLI/Python content — no root LICENSE; nested agent-starter-react MIT file is scoped to that subtree only',
    sourceUrl: 'https://github.com/Gauravsachdeva23e/Jarvis-One-Click-Set-Up',
    implementationStatus: 'source-review-required',
    state: 'not-installed',
    executionEnabled: false,
    capabilities: ['Local assistant setup UX review', 'Configuration and secret-hygiene design', 'Desktop-action consent boundary planning'],
    activationBoundary: 'reference-only',
    detail: 'Source-review intake only; no upstream setup script, provider, voice, camera, browser, MCP, file opener, shell or desktop runtime is started.',
  },
  {
    ...
    ownerCommander: 'Nox',
    license: 'Unverified — no repository LICENSE file or verified reuse grant at review',
    sourceUrl: 'https://github.com/Gauravsachdeva23e/Control_pc_using_Hand-Gesture',
    implementationStatus: 'source-review-required',
    state: 'not-installed',
    executionEnabled: false,
    capabilities: ['No-capture gesture UX review', 'Pointer-action approval design', 'Accessibility and emergency-stop planning'],
    activationBoundary: 'reference-only',
    detail: 'Source-review intake only; no upstream model, webcam, hand data, vision library, pointer, keyboard, desktop or automation runtime is started.',
  },
  {
