...
export const defaultFrameworks: FrameworkStatus[] = [
  {
    ...
    detail: 'Canonical mission engine; policy and approval remain in command.',
  },
  {
    id: 'swarms',
    label: 'Swarms',
    ...
    detail: 'Optional hierarchical worker adapter; intentionally inactive in V1.',
  },
  {
    id: 'agency-swarm',
    label: 'Agency-Swarm',
    ...
    state: 'not-installed',
    executionEnabled: false,
    detail: 'Optional role-handoff adapter; intentionally inactive in V1.',
  },
  {
    id: 'ruflo',
    label: 'Ruflo',
    ...
    state: 'not-installed',
    executionEnabled: false,
    detail: 'Optional local MCP bridge; intentionally inactive in V1.',
  },
]
